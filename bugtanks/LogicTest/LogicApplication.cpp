...
void LogicApplication::createObjects()
{
	...
	safeQueueEvent(EventDataPtr(myNew EvtData_To_ActorCreateTank(Tank::TankType_LongRange, utilities::Position(0.0f, 0.0f, 20.0f), utilities::Direction(1.0f, 0.0f, 0.0f), Actor::PlayerMovingInfo())));

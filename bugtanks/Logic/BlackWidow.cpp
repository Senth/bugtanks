...
BlackWidow::BlackWidow(int networkId, utilities::Position pos, utilities::Direction dir) :
	Enemy(networkId, ActorConstants::BLACKWIDOW_HP, ActorConstants::ANT_DAMAGE, Enemy::Size_Medium, ActorConstants::ANT_RANGE, pos, dir, utilities::MapCoordinate(3,2), ai::AiBehavior_RangedAttacker)
{
	...
	mpEnemyWeapon = myNew AcidSpit(ActorConstants::BLACKWIDOW_DAMAGE, 1.0f, ActorConstants::BLACKWIDOW_RANGE);

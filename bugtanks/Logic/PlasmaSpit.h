...
#ifndef __PLASMASPIT_H__
#define __PLASMASPIT_H__

namespace logic 
{

/**
 * This is a subclass to enemy weapon, this is the plasma beetles weapon
 */

class PlasmaSpit : public EnemyWeapon
{
 ...
 */
	PlasmaSpit(float damage, float weaponCooldown, float range);

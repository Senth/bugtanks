...
Enemy(networkId, ActorConstants::TARANTULA_HP, ActorConstants::ANT_DAMAGE, Enemy::Size_Medium, ActorConstants::TARANTULA_RANGE, pos, dir, utilities::MapCoordinate(3,2), ai::AiBehavior_MeleeAttacker)
{
...
{
	Actor *pActor = ActorHandler::getInstance()->getActor(PlayerInfo::getInstance()->getPlayerId());

...
namespace gfx
{
	...
	class DX10Module : public utilities::Thread
	{
		public:
			...
			/**
			 * Returns particle system by name
			 */
			Particle* getParticles(char* name) { return mParticleHandler.getParticleSystem(name); };

			/**
			 * Returns particle system by index
			 */
			Particle* getParticles(int index) { return mParticleHandler.getParticleSystem(index); };
